...
file_path = "/home/tjbouchard/dgnn/cgcnndefect/examples/OxideMLpaper1/pretraindata/id_prop.csv.pretrain"
...
for pct in percentages:
    ...
    # Save to file
    output_file = os.path.join(output_dir, f"id_prop.csv.pretrain{pct}pct")
